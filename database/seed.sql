...
(1, 'Savon Beldi MAHA', 45.00, 120, 'assets/images/products/savonBeldi.png', 1, 2, 'Savon Beldi traditionnel marocain, enrichi à l\'huile d\'olive naturelle. Il nettoie la peau en profondeur, élimine les cellules mortes et laisse la peau douce, lisse et éclatante. Idéal pour le hammam et les soins du corps.', 1, '2026-06-13 17:30:00'),
...
(11, 'aaa', 150.00, 20, NULL, 6, 7, 'aaaaaaaa', 1, '2026-06-14 21:18:15');

INSERT INTO `produit_caracteristique` (`ID_Caract`, `ID_Prod`, `texte`, `sort_order`) VALUES
(1, 1, 'Recette traditionnelle marocaine', 1),
(2, 1, 'À base d\'huile d\'olive pure', 2),
(3, 1, 'Texture pâteuse pour hammam', 3),
(4, 1, 'Nettoyage doux et exfoliation naturelle', 4),
(5, 2, 'Pressée à froid à partir d\'amandons d\'argan', 1),
(6, 2, '100% pure et biologique', 2),
(7, 2, 'Hydratation intense pour peau et cheveux', 3),
(8, 2, 'Riche en vitamine E et acides gras essentiels', 4),
(9, 3, 'Laine naturelle de haute qualité', 1),
(10, 3, 'Motifs berbères traditionnels', 2),
(11, 3, 'Teinture indigo artisanale', 3),
(12, 3, 'Pièce unique faite à la main', 4),
(13, 4, 'Pressée à froid', 1),
(14, 4, '100% olives locales', 2),
(15, 4, 'Saveur fruitée et équilibrée', 3),
(16, 4, 'Riche en antioxydants et vitamines', 4),
(17, 5, 'Terre cuite naturelle', 1),
(18, 5, 'Fabrication artisanale à la main', 2),
(19, 5, 'Résistant à la chaleur et durable', 3),
(20, 5, 'Idéal pour cuisson lente et saveurs authentiques', 4),
(21, 6, 'Tissu 100% coton léger', 1),
(22, 6, 'Broderies artisanales indigo', 2),
(23, 6, 'Coupe traditionnelle marocaine', 3),
(24, 6, 'Confort et élégance pour occasions spéciales', 4);

INSERT INTO `produit_image` (`ID_Image`, `ID_Prod`, `image_path`, `is_main`, `sort_order`) VALUES
(1, 1, 'assets/images/product-details/savonBeldi/savonBeldi.png', 1, 1),
(2, 1, 'assets/images/product-details/savonBeldi/savonBeldiAkarFasi.jpeg', 0, 2),
(3, 1, 'assets/images/product-details/savonBeldi/savonBeldiFlowers.jpeg', 0, 3),
(4, 1, 'assets/images/product-details/savonBeldi/savonBeldiHerbs.jpeg', 0, 4),
(5, 1, 'assets/images/product-details/savonBeldi/savonBeldiNila.jpeg', 0, 5),
(6, 1, 'assets/images/product-details/savonBeldi/savonBeldiSouffre.jpeg', 0, 6),
(7, 2, 'assets/images/product-details/arganOil/huileArganBio.png', 1, 1),
(8, 2, 'assets/images/product-details/arganOil/arganOilCosmetics.jpg', 0, 2),
(9, 3, 'assets/images/product-details/tapisAI/tapisAzilalIndigo.png', 1, 1),
(10, 3, 'assets/images/product-details/Tapis AI/TAI_ALL.jpg', 0, 2),
(11, 3, 'assets/images/product-details/Tapis AI/TAI_Details.jpg', 0, 3),
(12, 4, 'assets/images/product-details/oliveOil/huileOliveVierge.png', 1, 1),
(13, 4, 'assets/images/product-details/oliveOil/oliveOilBottle.jpeg', 0, 2),
(14, 5, 'assets/images/product-details/tagineTerracotta/tagineTerracotta.png', 1, 1),
(15, 5, 'assets/images/product-details/Tagine Terracotta/TT-Inside.jpg', 0, 2),
(16, 5, 'assets/images/product-details/Tagine Terracotta/TT_Details.jpg', 0, 3),
(17, 5, 'assets/images/product-details/Tagine Terracotta/TT-Size.jpg', 0, 4),
(18, 6, 'assets/images/product-details/kaftan/kaftanBleuIndigo.png', 1, 1),
(19, 6, 'assets/images/product-details/kaftan/kaftanBleuIndigoBack.jpeg', 0, 2),
(20, 6, 'assets/images/product-details/kaftan/kaftanBleuIndigoFront.jpeg', 0, 3),
(21, 6, 'assets/images/product-details/kaftan/kaftanBleuIndigoStyle.jpeg', 0, 4),
(22, 6, 'assets/images/product-details/kaftan/kaftanBleuIndigoMain.jpeg', 0, 5);
...
INSERT INTO `produit_option_valeur` (`ID_Valeur`, `ID_Option`, `valeur`, `sort_order`) VALUES
(1, 1, 'Small', 1),
(2, 1, 'Medium', 2),
(3, 1, 'Large', 3),
(4, 2, 'BLUE NILLA', 1),
...
INSERT INTO `traceabilite` (`ID_Trace`, `ID_Prod`, `titre`, `description`, `lieu`, `date_trace`, `icone`, `image_path`, `sort_order`) VALUES
(1, 1, 'Récolte / Production', 'Les matières premières ont été récoltées par la coopérative partenaire.', 'Atlas, Maroc', '15 Mars 2024', 'bi-person', 'assets/images/product-details/tracabiliteStep/traceabiliteStep1.png', 1),
(2, 1, 'Fabrication Artisanale', 'Création par les maîtres artisans selon les techniques traditionnelles.', 'Fès, Maroc', '20 Mars 2024', 'bi-gear', 'assets/images/product-details/tracabiliteStep/traceabiliteStep2.jpeg', 2),
(3, 1, 'Contrôle & Emballage', 'Vérification qualité et conditionnement avec code QR traçabilité.', 'Casablanca, Maroc', '28 Mars 2024', 'bi-box-seam', 'assets/images/product-details/tracabiliteStep/traceabiliteStep3.jpeg', 3),
(4, 1, 'Livraison', 'Expédié avec soin jusqu\'à votre domicile.', 'Votre adresse', 'En attente', 'bi-truck', 'assets/images/product-details/tracabiliteStep/traceabiliteStep4.jpeg', 4),
(5, 2, 'Récolte / Production', 'Les matières premières ont été récoltées par la coopérative partenaire.', 'Atlas, Maroc', '15 Mars 2024', 'bi-person', 'assets/images/product-details/tracabiliteStep/traceabiliteStep1.png', 1),
(6, 2, 'Fabrication Artisanale', 'Création par les maîtres artisans selon les techniques traditionnelles.', 'Fès, Maroc', '20 Mars 2024', 'bi-gear', 'assets/images/product-details/tracabiliteStep/traceabiliteStep2.jpeg', 2),
(7, 2, 'Contrôle & Emballage', 'Vérification qualité et conditionnement avec code QR traçabilité.', 'Casablanca, Maroc', '28 Mars 2024', 'bi-box-seam', 'assets/images/product-details/tracabiliteStep/traceabiliteStep3.jpeg', 3),
(8, 2, 'Livraison', 'Expédié avec soin jusqu\'à votre domicile.', 'Votre adresse', 'En attente', 'bi-truck', 'assets/images/product-details/tracabiliteStep/traceabiliteStep4.jpeg', 4);

INSERT INTO `utilisateur` (`ID_utili`, `nom`, `prenom`, `email`, `mot_de_passe`, `role`, `telephone`, `adresse`, `est_active`, `created_at`) VALUES
(1, 'Ahmadiiii', 'Ahmedddd', 'client@test.com', '$2y$12$w9h9a1bNDUryRAPSCLczY.ASU0OVOP7hguc0CCZXVtewI7kRs4zie', 'client', '+212 6 00 00 00 00', 'Marrakech, Maroc', 1, '2026-06-13 17:00:21'),
(2, 'Test2', 'Producteur', 'producteur@test.com', '$2y$12$w9h9a1bNDUryRAPSCLczY.ASU0OVOP7hguc0CCZXVtewI7kRs4zie', 'producteur', '+212 6 11 11 11 11', 'Agadir, Maroc', 1, '2026-06-13 17:00:21'),
...
(5, 'Mansouri', 'Ahmed', 'ahmed.m@test.com', '$2y$10$Y46.6hCo.9iBVE78sLbqOOy2JaqB7cyo9Ik9mdDWOFDxG3d9GkNie', 'client', '+212 6 22 22 22 22', 'Marrakech, Maroc', 1, '2026-06-13 17:10:00');
COMMIT;
