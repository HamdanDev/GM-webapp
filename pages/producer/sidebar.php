            <div class="col-12 col-md-3">
                <div class="profile-sidebar p-3">
                    ...
                    <div class="d-flex flex-column gap-1 sidebar-menu">
                        ...
                        <a class="sidebar-link" data-section="stock" href="#">
                        ...
                        <a class="sidebar-link" data-section="Notification" href="#">
                    ...
                    <hr />
                    <a class="sidebar-link text-danger" href="../actions/logout.php">
