                        ...
                        <form method="post">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="nom" required type="text" value="<?= e($profileUser['nom'] ?? '') ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Prénom</label>
                                    <input class="form-control" name="prenom" required type="text" value="<?= e($profileUser['prenom'] ?? '') ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Email</label>
                                    <input class="form-control" name="email" required type="email" value="<?= e($profileUser['email'] ?? '') ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold">Téléphone</label>
                                    <input class="form-control" name="telephone" type="tel" value="<?= e($profileUser['telephone'] ?? '') ?>" />
                                </div>
                                <div class="col-12">
                                    <label class="form-label small fw-bold">Adresse</label>
                                    <input class="form-control" name="adresse" type="text" value="<?= e($profileUser['adresse'] ?? '') ?>" />
                                </div>
                                <div class="col-12">
                                    <hr />
